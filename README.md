...
This is a simple, beginner-friendly workflow. For local hosting and customization, see [Local Serving & Image Configuration](#local-serving--image-configuration).
